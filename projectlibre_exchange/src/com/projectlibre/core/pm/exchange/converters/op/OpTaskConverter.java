...
public class OpTaskConverter {
	...
	protected String[] fieldsToConvert=new String[]{
		...
		"fixedCostAccrual", "fixedCostAccrual", "com.projectlibre.core.pm.exchange.converters.op.type.OpAccrueTypeConverter",
		"stop", "stop", "com.projectlibre.core.pm.exchange.converters.type.LongDateConverter",
		"effortDriven", "effortDriven", null,
		"schedulingType", "schedulingType", "com.projectlibre.core.pm.exchange.converters.op.type.OpSchedulingTypeConverter",		
		"milestone", "markTaskAsMilestone", null,
		"earnedValueMethod","earnedValueMethod", "com.projectlibre.core.pm.exchange.converters.op.type.OpEarnedValueMethodConverter",
