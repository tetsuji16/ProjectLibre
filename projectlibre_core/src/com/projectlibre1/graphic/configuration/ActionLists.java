...
public class ActionLists implements NamedItem {
	...
	public ActionList getActionList(String id) {
		ActionList actionList=(ActionList)actionListMap.get(id);
	    if (actionList==null){
	...
	public ActionListFactory getFactory(String id) {
		return (ActionListFactory)factoryMap.get(id);
	}
	...
	public static void addDigesterEvents(Digester digester){
		...
		digester.addObjectCreate("*/actionLists", "com.projectlibre1.graphic.configuration.ActionLists");
	    digester.addSetProperties("*/actionLists");
		digester.addSetNext("*/actionLists", "add", "com.projectlibre1.configuration.NamedItem");

		// start section
		digester.addObjectCreate("*/actionLists/actionList", "com.projectlibre1.graphic.configuration.ActionListFactory");
	    ...
	    digester.addSetNext("*/actionLists/actionList", "addActionList", "com.projectlibre1.graphic.configuration.ActionListFactory");
