...
public class CostRateTable extends ValueObjectForIntervalTable{
	static final long serialVersionUID = 555455555229L;
	public CostRateTable(String name) {
		super(name);
//		initUndo();
	}
...
//		initUndo();
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.costing.ValueObjectForIntervalTable#createValueObject(long)
	 */
	protected ValueObjectForInterval createValueObject(long date) {
		return new CostRate(this,date);
	}

	
	
	public static CostRateTable deserialize(ObjectInputStream s) throws IOException, ClassNotFoundException  {
