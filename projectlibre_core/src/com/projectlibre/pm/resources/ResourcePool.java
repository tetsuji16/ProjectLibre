...
public class ResourcePool extends AbstractNodeContainer implements HasCalendar{
	...
	public ResourcePool(){
		unassignedResource=new Resource();
		unassignedResource.setUnassigned();
	}
	...
	public void addResource(Resource resource){
		...
		getHierarchy().add(resource);
	}

	public Resource getUnassignedResource() {
	...
	public String toString(String tab){
		...
		if (unassignedResource==null)
			...
			s.append(tab).append("unassignedResource=").append('\n');
			s.append(unassignedResource==null? null : unassignedResource.toString(tab+"\t")).append('\n');
		}
		s.append(tab).append("resources=").append('\n');
		for (Resource resource : resources)
			s.append(resource.toString(tab+"\t"));
		return s.toString();
	}
