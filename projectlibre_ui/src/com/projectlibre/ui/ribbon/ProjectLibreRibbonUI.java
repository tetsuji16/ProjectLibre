...
//		});
		...
		applicationMenuButton.addMouseListener(new MouseAdapter() { // popup is
					...
					public void mousePressed(MouseEvent me) {
						BrowserControl
								.displayURL("https://github.com/tetsuji16/ProjectLibre");
					}
				});
	}
...
//		// projectlibre
//		if (ribbon.getProjectLibreLogo() != null)
//			ribbon.remove(ribbon.getProjectLibreLogo());
...
//				ribbon.getProjectLibreLogo().setVisible(true); // projectlibre
				if (ribbon.getApplicationMenu() != null) {
					if (ltr) {
						applicationMenuButton.setBounds(x, ins.top
								+ appMenuButtonYOffset, appMenuButtonWidth,
								appMenuButtonHeight);
//						ribbon.getProjectLibreLogo().setBounds(
//								x + projectlibre1LogoXOffset,
//								ins.top + taskbarHeight
//										+ taskToggleButtonHeight
//										- projectlibre1LogoHeight
//										+ projectlibre1LogoYOffset,
//								projectlibre1LogoWidth, projectlibre1LogoHeight); // projectlibre
					} else {
				...
				ribbon.getProjectLibreLogo().setVisible(false); // projectlibre
			}
			x = ltr ? x + 2 : x - 2;
