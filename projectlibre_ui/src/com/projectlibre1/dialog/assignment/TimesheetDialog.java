...
public class TimesheetDialog extends AbstractDialog implements CommonAssignmentDialog {
	...
	private final List selectedResources;
	...
	public TimesheetDialog(DocumentFrame documentFrame, List selectedResources) {
	...
	private void updateSelectionLabel() {
		...
		int index = 0;
		for (Iterator i = selectedResources.iterator(); i.hasNext() && index < 5; index++) {
