...
//			projectName.setText(project == null ? "" : "Resources from: " + project.getName());
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.graphic.spreadsheet.selection.SelectionNodeListener#selectionChanged(com.projectlibre1.pm.graphic.spreadsheet.selection.SelectionNodeEvent)
	 */
