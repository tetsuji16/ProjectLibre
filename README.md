...
- `build\releases\v0.0.18\jpackage-input\`

The local MSI output is generated under:

- `build\releases\v0.0.18\msi\ProjectLibre-0.0.18.msi`
...
Files under `docs/downloads/` are treated as scratch space only and should not be committed. Public downloads should be published as GitHub Release assets for `v0.0.18`, and the GitHub Pages site should link to that release page instead of serving binaries from the repository itself.
