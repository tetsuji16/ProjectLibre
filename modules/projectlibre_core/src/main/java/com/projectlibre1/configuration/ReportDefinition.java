...
public class ReportDefinition implements NamedItem {
    ...
    public static void addDigesterEvents(Digester digester){
		digester.addObjectCreate("*/reports/report", "com.projectlibre1.configuration.ReportDefinition");
		digester.addObjectCreate("*/reports/report/columns", "com.projectlibre1.configuration.ReportColumns");
	    digester.addSetProperties("*/reports/report");
	    digester.addSetProperties("*/reports/report/columns");
		digester.addSetNext("*/reports/report", "add", "com.projectlibre1.configuration.NamedItem");
		digester.addSetNext("*/reports/report/columns", "add", "com.projectlibre1.configuration.ReportColumns");
