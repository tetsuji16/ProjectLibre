...
public class CellStyles implements NamedItem {
	...
	public static void addDigesterEvents(Digester digester){
		...
		digester.addObjectCreate("*/cellstyles", "com.projectlibre1.graphic.configuration.CellStyles");
	    digester.addSetProperties("*/cellstyles");
		digester.addSetNext("*/cellstyles", "add", "com.projectlibre1.configuration.NamedItem");

		// start section
		digester.addObjectCreate("*/cellstyles/style", "com.projectlibre1.graphic.configuration.CellStyleFactory");
	    digester.addSetProperties("*/cellstyles/style");
	    digester.addCallMethod("*/cellstyles/style/formulaText","setFormulaText",0);
	    digester.addSetNext("*/cellstyles/style", "addStyle", "com.projectlibre1.graphic.configuration.CellStyleFactory");
