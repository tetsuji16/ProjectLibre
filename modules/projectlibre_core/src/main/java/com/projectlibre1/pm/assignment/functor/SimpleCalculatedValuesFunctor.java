 ...
 *
 */
public class SimpleCalculatedValuesFunctor implements CalculationVisitor, DoubleValue {
	 ...
	 * 
	 */
	private SimpleCalculatedValuesFunctor(CalculatedValues calculatedValues, TimeIteratorGenerator generator) {
	...
	public static SimpleCalculatedValuesFunctor getInstance(CalculatedValues calculatedValues, TimeIteratorGenerator generator) {
		return new SimpleCalculatedValuesFunctor(calculatedValues, generator);
	}
