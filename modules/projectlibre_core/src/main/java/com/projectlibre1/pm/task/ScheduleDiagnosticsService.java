...
public final class ScheduleDiagnosticsService {
	...
	public List<Issue> diagnose(Task task) {
		...
		for (var slot : project == null ? List.<com.projectlibre1.pm.resource.TeamPlannerService.Slot>of()
				: new com.projectlibre1.pm.resource.TeamPlannerService().slots(project)) {
