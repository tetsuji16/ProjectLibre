 ...
 * 
 */
public interface EarnedValueTaskSpecific {

	public double getCpi();
	public double getCpi(long start, long end);
	...
	public double getCvPercent(long start, long end);

	public double getSpi();
	public double getSpi(long start, long end);

	public double getSvPercent();
	public double getSvPercent(long start, long end);
