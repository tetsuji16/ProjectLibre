 ...
 *******************************************************************************/
package com.microproject.pm.scheduling.pert;

/**
 *
 */
public class PertWeights {
	double optimistic = 1.0;
	double expected = 4.0;
	double pessimistic = 1.0;
	/**
	...
	/**
	 * @return Returns the pessimistic.
	 */
	public double getPessimistic() {
		return pessimistic;
	}
	/**
	 * @param pessimistic The pessimistic to set.
	 */
