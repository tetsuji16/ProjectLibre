...
public interface DataObjectConstants {
    ...
    public static final int BANKING_INFO_TYPE=8;
    public static final int CREDIT_CARD_BANKING_INFO_TYPE=9;
    public static final int CHECK_BANKING_INFO_TYPE=10;
    public static final int USER_TYPE=11;
    public static final int PARTNER_USER_TYPE=12;
    public static final int PARTNER_COMPANY_TYPE=13;
}
