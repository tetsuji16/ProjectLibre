 ...
 *
 */
public abstract class GraphPopupMenu extends JPopupMenu{
    protected final GraphInteractor interactor;
	...
	/**
	 * Show the menu, making sure to build it fresh each time
	 */
