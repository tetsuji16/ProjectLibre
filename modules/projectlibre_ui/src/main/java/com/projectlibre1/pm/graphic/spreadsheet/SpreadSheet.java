...
//    }
	...
	private void removeExistingResources(ResourcePool resourcePool, HashMap<Long, EnterpriseResourceData> resourceMap) {
		List<com.projectlibre1.pm.resource.Resource> currentResources = resourcePool.getResourceList();
		for (com.projectlibre1.pm.resource.Resource resource : currentResources){
