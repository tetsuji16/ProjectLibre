...
public interface Association {
	Object getLeft();
	Object getRight();
	void testValid(boolean allowDuplicate) throws InvalidAssociationException;
	void copyPrincipalFieldsFrom(Association from);
    void doAddService(Object eventSource);
    void doRemoveService(Object eventSource);
