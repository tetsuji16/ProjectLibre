...
public class WorkWeek{
	...
	public void setDay(int i, WorkDay day){
		days[i]=day;
	}
	...
	public String toString(String tab){
		...
		s.append(tab).append("\t").append("days=\n");
		for (WorkDay day : days){
			if (day==null) s.append(tab).append("\t\t").append("null").append('\n');
			else s.append(day.toString(tab+"\t\t"));
		}
