...
public class WorkRange{
	...
	public WorkRange(DayType type) {
		super();
		this.type = type;
	}

	/**
	 * Valid for WORKING types only
	 */
	...
	public boolean isWorking(){
		return type==DayType.WORKING;
	}
	
	public boolean isNonWorking(){
		return type==DayType.NON_WORKING;
	}
	
	public boolean isDefault(){
		return type==DayType.DEFAULT;
	}
	

	@Override
	public boolean equals(Object obj) {
		if (obj==null || !(obj instanceof WorkRange))
			return false;
		WorkRange w=(WorkRange)obj;
		if (type!=w.getType())
			return false;
		if (isWorking() && !intervals.equals(w.getIntervals()))
			return false;
		return true;
	...
	public String toString(String tab){
		...
		s.append(tab).append("\t").append("intervals=\n");
		for (TimeInterval interval : intervals)
			s.append(tab).append("\t\t").append(interval).append('\n');
