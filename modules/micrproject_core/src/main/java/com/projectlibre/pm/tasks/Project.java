...
public class Project extends AbstractNodeContainer implements HasCalendar {
	...
	public String toString(String tab){
		...
		appendProjectHeader(s, tab);
		appendProjectState(s, tab);
		appendProjectChildren(s, tab);
		return s.toString();
	}

	private void appendProjectHeader(StringBuilder s, String tab) {
		s.append(tab).append("Project #").append(hashCode()).append('\n');
		s.append(super.toString("\t"));
	}

	private void appendProjectState(StringBuilder s, String tab) {
		...
		appendCalendar(s, tab);
		appendResourcePool(s, tab);
	}

	private void appendCalendar(StringBuilder s, String tab) {
		if (calendar == null) {
	...
	private void appendResourcePool(StringBuilder s, String tab) {
	...
	private void appendProjectChildren(StringBuilder s, String tab) {
		appendTasks(s, tab);
		appendDependencies(s, tab);
	}

	private void appendTasks(StringBuilder s, String tab) {
	...
	private void appendDependencies(StringBuilder s, String tab) {
