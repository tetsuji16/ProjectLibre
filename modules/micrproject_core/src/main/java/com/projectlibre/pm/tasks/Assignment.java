...
public class Assignment extends AbstractNode implements Schedule{
	...
	public String toString(String tab){
		...
		appendAssignmentHeader(s, tab);
		appendTimephased(s, tab);
		return s.toString();
	}

	private void appendAssignmentHeader(StringBuilder s, String tab) {
	...
	private void appendTimephased(StringBuilder s, String tab) {
		if (timephased == null) {
			s.append(tab).append("\t").append("timephased=null\n");
			return;
		}
