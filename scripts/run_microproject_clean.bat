...
set "LIB_DIR=%PROJECT_ROOT%\modules\microproject_ui\build\install\microproject_ui\lib"
...
if not exist "%LIB_DIR%\microproject_ui.jar" (
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$lib = '%LIB_DIR%';" ^
  "$arg = '%ARG_FILE%';" ^
  "$preferred = @('microproject_ui.jar','microproject_application.jar','microproject_exchange.jar','microproject_reports.jar','microproject_core.jar','projectlibre-contrib.jar');" ^
